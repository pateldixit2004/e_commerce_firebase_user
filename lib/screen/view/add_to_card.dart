        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            for (var x in querysnapList) {
              ...
              AddtoCardModel model = AddtoCardModel(
                  name: name,
                  cate: cat,
                  dec: dec,
                  img: img,
            ...
            return InkWell(
              ...
              child: Column(
                children: [
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: NetworkImage("${cardList[index].img}"),
                                  ),
                                ),
                              ),
                              SizedBox(
                              ...
                              SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text("${cardList[index].name}",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
                                    SizedBox(
                                      height: 0.5.h,
                                    ),
                                    Obx(
                                      () => Text(
                                          "Quantity ${controller.qut.value}"),
                                    ),
                                  ],
                                ),
                              ),
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        IconButton(
                                            onPressed: () {
                                              FireBaseHelper.base.deleteCart(
                                                  "${cardList[index].id}");
                                            },
                  ...
                  Spacer(),
                  Text("Totol Amount=${controller.totalprice.value}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black),),
                ],
